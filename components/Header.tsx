        ...
        <div className="bg-gradient-to-br from-primaryDark via-primary to-[#0f8267] px-5 py-4 text-white">
            <div className="flex items-center gap-2.5 max-w-[600px] mx-auto">
                ...
                <div className="flex-1 min-w-0">
                    <div className="text-2xl font-extrabold tracking-tighter font-serif">{title}</div>
                    <div className="text-sm opacity-90 font-medium">{subtitle}</div>
                </div>
                {userEmail && (
                    <div className="flex items-center gap-2">
                        <div className="text-right">
                            <div className="text-base font-bold truncate max-w-[140px]">{userName || userEmail}</div>
